...
function kriging(id, pixelsize) {
  ...
  this.canvas.zoom = function (zoom, yxratio, pixelsize) {
    ...
    var center = [(this.xlim[1] - this.xlim[0]) / 2 + this.xlim[0], (this.ylim[1] - this.ylim[0]) / 2 + this.ylim[0]];
  ...
  this.canvas.colorspectrum.heatcolors = [
    "#FF0000",
    "#FF0700",
    "#FF0E00",
    "#FF1500",
  ...
  this.canvas.colorspectrum.terraincolors = [
    "#00A600",
    "#07A800",
    "#0EAB00",
    "#16AE00",
  ...
  this.canvas.colorspectrum.topocolors = [
    "#4C00FF",
    "#3B00FF",
    "#2800FF",
    "#1600FF",
  ...
  this.canvas.colorspectrum.cmcolors = [
    "#80FFFF",
    "#85FFFF",
    "#8AFFFF",
    "#8FFFFF",
