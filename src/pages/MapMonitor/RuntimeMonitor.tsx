    ...
    columns: [
      ...
      },
      {
        ...
        render: (text, record) => <div
          className={record.siteId == store.curSiteId ? "primary-button-text-dark" : "primary-text-color"}>{text}</div>,
      },
      {
        title: "站点",
        dataIndex: "siteName",
        ...
        <div className="monitor-row-panel pl-4 pt-4 pb-4">
          <Scrollbars style={{height: "calc(100vh - 64px)"}}>
            ...
            <div className="mr-4">
              ...
              <div className="mt-4">
                <LineChart
                  datas={store.siteData?.dataTrend.map((i) => ({upperLimit: 0, ...i, datas: i.points}))}></LineChart>
              </div>
            </div>
          </Scrollbars>
        </div>
