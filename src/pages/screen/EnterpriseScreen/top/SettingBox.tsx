...
export const SettingBox = () => {
  ...
  return useObserver(() => (
    <div className="absolute screenSetting z-50 mt-8"
         style={{width: 350, height: 500, left: "60%", display: enterpriseScreenMap.boxDisplay ? "block" : "none"}}>
          ...
          <TabPane tab="因子配置" key="1">
            <div>
              <div className="flex" style={{height: 320}}>
                <Checkbox.Group className="w-full" onChange={enterpriseScreenMap.selectPmCode}
                                value={enterpriseScreenMap.selectedPmCodes}>
                  <div className="flex">
