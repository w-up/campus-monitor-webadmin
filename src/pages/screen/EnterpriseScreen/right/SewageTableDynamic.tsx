  ...
  return useObserver(() => (
    <div className="topRight screenTable flex-1">
      ...
      <div className="box">
        ...
        <CarouselProvider naturalSlideWidth={100} dragEnabled={store.carouselProviderPlay} naturalSlideHeight={60} totalSlides={enterpriseScreenMap.SiteRuntimePmDate.length}>
          <Slider>
