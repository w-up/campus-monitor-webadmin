            ...
            <Card
              ...
              extra={
                ...
                <Card title="厂区范围" bordered size="small">
                  ...
                  <Table pagination={false} size="small" bordered dataSource={toJS(scope)} footer={_ => factoryInfoEditable && <Button onClick={addScope} size="small" shape="circle" icon="plus" />}>
                    <Column
                      title="名称"
                      dataIndex="scopeName"
                      key="scopeName"
