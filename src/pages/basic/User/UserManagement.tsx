...
export const UserManagementPage = Form.create()(
  observer((props: any) => {
    const {
      base: { user },
    } = useStore();
            ...
            <Row>
              <Form layout="inline" onSubmit={handleSearch}>
                ...
                <Col span={8} style={{ textAlign: "right" }}>
                  <Form.Item>
                    <Button type="primary" onClick={() => props.history.push("/user/user-edit")}>
                      新建
                    </Button>
                    <Button style={{ marginLeft: 5 }} onClick={onBatchDeleteUser}>
                      批量删除
                    </Button>
                    <Button style={{ marginLeft: 5 }} onClick={handleResetPasswrod}>
                      密码重置
                    </Button>
                  </Form.Item>
                </Col>
