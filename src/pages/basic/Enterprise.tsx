...
export const EnterprisePage = observer(() => {
  ...
  return (
    <div className="enterprisePage">
          ...
          <Row>
            <Form layout="inline" onSubmit={handleSearch}>
              ...
              <Col span={8} style={{ textAlign: "right" }}>
                <Form.Item>
                  <Button type="primary">
                    <Link to="/base/enterprise-edit">新建</Link>
                  </Button>
                  <Button onClick={onBatchDeleteEnterprise} style={{ marginLeft: 5 }}>
                    批量删除
                  </Button>
                </Form.Item>
              </Col>
      ...
      <div className="fixed bottom-0 text-center pb-1" style={{ width: "calc(100% - 200px)", color: "white" }}>
        版权所有: 武汉三藏科技有限责任公司
      </div>
    </div>
  );
